        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, cardUtils.checkCard(id)];
                case 1:
                    _b.sent();
                ...
                case 3:
                    _b.sent();
                    return [4 /*yield*/, cardServices.getCardBalance(id)];
                case 4:
                    balance = _b.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, cardServices.postPayment(id, password, amount, businessId)];
                case 1:
                    _b.sent();
                    res.sendStatus(200);
                    return [2 /*return*/];
